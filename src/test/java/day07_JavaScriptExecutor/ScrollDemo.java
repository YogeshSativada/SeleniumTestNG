package day07_JavaScriptExecutor;
...
//		js.executeScript("window.scrollBy(0, 300);");                 //using pixel
		
//		js.executeScript("argument[0].scrollIntoView(true);", element);             scroll to particular element
